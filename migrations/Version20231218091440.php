 ...
 */
final class Version20231218091440 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE navire ADD type_id INT NOT NULL, ADD longueur INT NOT NULL, ADD largeur INT NOT NULL, ADD tirantdeau INT NOT NULL');
